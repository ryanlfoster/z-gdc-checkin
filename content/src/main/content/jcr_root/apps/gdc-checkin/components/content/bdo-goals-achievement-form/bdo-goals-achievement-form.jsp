    ...
    <c:choose>
        <c:when test = "${editForm eq 'true'}">
            <div class="row">
                ...
                <div class="col-md-10 col-xs-10 margin profile-container">
                   <c:if test="<%=StringUtils.isNotBlank(request.getParameter("editBdoScore"))%>">
                       <img src="http://img-prod.corp.adobe.com:8080/is/image/${userID}.00.jpg?fm-jpg&wid=180&hei=241&op_sharpen=1" onerror="this.src='/etc/designs/gdc-checkin/clientlibs-internal/images/admin-profile.jpg'" class="profile-img" width="90" height="95">
                   </c:if>
